...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " data-bs-target="#library" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Library</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="library" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="../borrow" class="active">
              <i class="bi bi-circle"></i><span>Borrow a book</span>
            </a>
          </li>
          <li>
